...
- **ターミナルタイトル更新**: 状態変更時の`echo -ne "\033]0;[STATUS→[マネージャーpane_id]]\007"`実行
...
3. **ターミナルタイトル更新**: `echo -ne "\033]0;[WORKING→[マネージャーpane_id]]\007"`実行
