...
- **Location**: `{baseDirectory}/.agent/breakdown/config/app.yml` or `{baseDirectory}/.agent/breakdown/config/{profilePrefix}-app.yml`
...
- **Location**: `{working_dir}/.agent/breakdown/config/user.yml` or `{working_dir}/.agent/breakdown/config/{profilePrefix}-user.yml`
...
- **Purpose**: Determine the placement location of user configuration files (`{working_dir}/.agent/breakdown/config/user.yml` etc.)
- **Default Value**: "./.agent/breakdown"
...
- **Example**: `app_prompt.base_dir: "./.agent/breakdown/prompts/app"`
...
- **Default Value**: "./.agent/breakdown/prompts/app"
...
- **Configuration Items**: `base_dir` (Base folder specification)
- **Default Value**: "./.agent/breakdown/schema/app"
...
- **Application Configuration File**: `baseDirectory + /.agent/breakdown/config/ + [profilePrefix-]app.yml`
- **User Configuration File**: `working_dir + /.agent/breakdown/config/ + [profilePrefix-]user.yml`

### Comparison in Configuration Examples

```yaml
# Application configuration file (app.yml)
working_dir: "./.agent/breakdown" # System-wide standard
app_prompt:
  base_dir: "./.agent/breakdown/prompts/app" # Prompt function standard
app_schema:
  base_dir: "./.agent/breakdown/schema/app" # Schema function standard
```
...
2. Application configuration files are loaded from `{baseDirectory}/.agent/breakdown/config/`
3. User configuration files are loaded from `{working_dir}/.agent/breakdown/config/`
...
| **Placement Rule** | Unified placement under `.agent/breakdown/config/` |
